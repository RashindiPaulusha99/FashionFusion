                                ...
                                <div className="tab-pane fade show active" id="nav-all" role="tabpanel"
                                    ...
                                    <Box sx={{ flexGrow: 1 }} >
                                        <Grid container spacing={3} columns={{ xs: 4, sm: 8, md: 12 }} >
                                            {posts.slice(0, itemsToShow).map(({_id,item_image,name,sizes,unit_price,colours,brand}, index) =>(
                                                <Grid item xs={4} lg={2.4} md={2.4}  key={index} >
                                                    <div className="col" style={{cursor:'pointer'}} onClick={(e)=> handleClickOpen(_id)}>
                                                        <div className="product-item">
                                                            ...
                                                            <h3>{name}</h3>
                                                            <span className="brand">{brand}</span><span className="rating"><svg width="24" height="24" className="text-primary"><use xlinkHref="#star-solid"></use></svg> 4.5</span>
